...
${errorInfo.componentStack}`);
  ...
  // node_modules/@shopify/ui-extensions-react/build/esm/surfaces/checkout/hooks/billing-address.mjs
  ...
  // extensions/country-banner-extension/src/Checkout.tsx
  ...
  function Extension() {
    const { bannerTitle, bannerText, bannerStatus, textSize } = useSettings();
    ...
    const { countryCode } = useBillingAddress();
    (0, import_react12.useEffect)(() => {
      const selectedCountry = countries.some(
        (country) => country.code === countryCode
      );
      setIsAvailable(selectedCountry);
    }, [countryCode]);
    return /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(import_jsx_runtime4.Fragment, { children: isAvailable && /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(
      Banner2,
      {
        title: bannerTitle ? bannerTitle : "Banner Title",
        status: bannerStatus ? bannerStatus : "info",
        children: /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(
          Text2,
          {
            size: textSize ? textSize : "extraSmall",
            children: bannerText ? bannerText : "Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s"
          }
        )
      }
    ) });
...
//# sourceMappingURL=country-banner-extension.js.map
